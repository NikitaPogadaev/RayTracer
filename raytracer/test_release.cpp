...
TEST_CASE("Classic box") {
    CameraOptions camera_opts{.screen_width = 500,
                              ...
                              .look_from = {-.5, 1.5, .98},
                              .look_to = {0., 1., 0.}};
    CheckImage("classic_box/CornellBox.obj", "classic_box/first.png", camera_opts, {4}, std::filesystem::path("./kek1.png"));
    camera_opts.look_from = {-.9, 1.9, -1};
    camera_opts.look_to = {0., 0., 0.};
    CheckImage("classic_box/CornellBox.obj", "classic_box/second.png", camera_opts, {4}, std::filesystem::path("./kek2.png"));
}
...
TEST_CASE("Mirrors") {
    CameraOptions camera_opts{.screen_width = 800,
                              ...
                              .look_from = {2., 1.5, -.1},
                              .look_to = {1., 1.2, -2.8}};
    CheckImage("mirrors/scene.obj", "mirrors/result.png", camera_opts, {9}, std::filesystem::path("./kek3.png"));
}
